...
from .views import UserCartView, RemoveCartItemView, AddToCartView, UpdateCartItemQuantityView, GetApplicableCombosView
...
urlpatterns = [
    ...
    path("applicable-combos/", GetApplicableCombosView.as_view(), name="applicable-combos"),
]
